...
<html>
	...
	<body>
		...
		<div id="tb" style="padding: 2px;">
			<div style="margin-bottom:2px">
				<table cellspacing="0" cellpadding="0">
					<tr>
						<permission:dom id="1588655886924052">
						<td>
						...
						<permission:dom id="1588655886924054">
						<td>
						...
						<permission:dom id="1588655886924053">
						<td>
			...
			<div id="qf">
				...
				<permission:dom id="1588655886924051">
		...
		<div id="dlg" class="easyui-dialog" style="width:784px;height:'auto';padding:10px 20px"
			...
			<div class="ftitle">运营商应用信息</div>
			<form id="fm" method="post" novalidate class="bootstrap-frm">
			<input type="hidden" name="appProducctId"/>
				<!-- 表单table start-->
				<table width="100%"  border="0" id="table_add">
					<tr>
						...
						<td class="text_cloumn2">
							...
							autocomplete="off" placeholder="请输入运营商,长度为[1-5]"  data-options="required:true,validType:['length[1,5]']"/>
						</td>
						...
						<td class="text_cloumn2">
							...
							autocomplete="off" placeholder="请输入应用ID,长度为[1-20]"  data-options="required:true,validType:['length[1,20]']"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="text_cloumn2">
							...
							autocomplete="off" placeholder="请输入应用图标,长度为[0-16777215]"  data-options="required:false,validType:['length[0,16777215]']"/>
						</td>
						...
						<td class="text_cloumn2">
							...
							autocomplete="off" placeholder="请输入应用描述,长度为[0-256]"  data-options="required:false,validType:['length[0,256]']"/>
						</td>
					</tr>
					<tr>
						...
						<td class="text_cloumn2">
							...
							autocomplete="off" placeholder="请输入应用类型,长度为[0-10]"  data-options="required:false,validType:['length[0,10]']"/>
						</td>
...
<script type="text/javascript">
	$('#dg').datagrid({
		 ...
		 rownumbers:true,
		 sortOrder: 'desc',
		 sortName: 'appProducctId',
		 frozenColumns : [ [ {
			 field : 'ck',
			 checkbox : true
		 } ] ], 
		 idField:'appProducctId', 
		  columns: [[ 
			  { field: 'appProducctId', title: '应用产品ID', width: 106, align: 'left', sortable: true },
