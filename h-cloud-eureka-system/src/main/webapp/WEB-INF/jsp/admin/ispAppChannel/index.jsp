...
<html>
	...
	<body>
		...
		<div id="tb" style="padding: 2px;">
			<div style="margin-bottom:2px">
				<table cellspacing="0" cellpadding="0">
					<tr>
						<permission:dom id="1588655886924057">
						<td>
						...
						<permission:dom id="1588655886924059">
						<td>
						...
						<permission:dom id="1588655886924058">
						<td>
			...
			<div id="qf">
				...
				<permission:dom id="1588655886924056">
		...
		<div id="dlg" class="easyui-dialog" style="width:784px;height:'auto';padding:10px 20px"
			...
			<div class="ftitle">通道产品能力信息</div>
			<form id="fm" method="post" novalidate class="bootstrap-frm">
			<input type="hidden" name="id"/>
				<!-- 表单table start-->
				<table width="100%"  border="0" id="table_add">
					<tr>
						<td class="label_cloumn2">*&nbsp;应用产品ID：</td>
						<td class="text_cloumn2">
							<input type="text" id="appProducctId" name="appProducctId" class="easyui-validatebox textbox" value="" autofocus="autofocus"
							autocomplete="off" placeholder="请输入应用产品ID,长度为[0-19]"  data-options="required:false,validType:['isDigit','length[0,19]']"/>
						</td>
					...
					<tr>
						<td class="label_cloumn2">*&nbsp;通道ID：</td>
						<td class="text_cloumn2">
							<input type="text" id="channelId" name="channelId" class="easyui-validatebox textbox" value="" autofocus="autofocus"
							autocomplete="off" placeholder="请输入通道ID,长度为[0-10]"  data-options="required:false,validType:['isDigit','length[0,10]']"/>
						</td>
						<td class="label_cloumn2">*&nbsp;通道名称：</td>
						<td class="text_cloumn2">
							<input type="text" id="channeName" name="channeName" class="easyui-validatebox textbox" value="" autofocus="autofocus"
							autocomplete="off" placeholder="请输入通道名称,长度为[0-20]"  data-options="required:false,validType:['length[0,20]']"/>
						</td>
					</tr>
					<tr>
						...
						<td class="text_cloumn2">
							...
							autocomplete="off" placeholder="请输入应用ID,长度为[0-20]"  data-options="required:false,validType:['length[0,20]']"/>
						</td>
	...
	$('#dg').datagrid({
		 ...
		 idField:'id', 
		  columns: [[ 
			  ...
			  { field: 'appProducctId', title: '应用产品ID', width: 104, align: 'left', sortable: true },
			  { field: 'isp', title: '运营商', width: 76, align: 'left', sortable: true },
			  { field: 'channelId', title: '通道ID', width: 86, align: 'left', sortable: true },
			  { field: 'channeName', title: '通道名称', width: 106, align: 'left', sortable: true },
			  { field: 'appId', title: '应用ID', width: 106, align: 'left', sortable: true },
