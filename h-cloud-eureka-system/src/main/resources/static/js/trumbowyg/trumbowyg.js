...
(function (navigator, window, document, $) {
    ...
    Trumbowyg.prototype = {
        ...
        htmlEncode : function (html){
            ...
            // var s = temp.innerHTML;
            // temp = null;

            s = html.replace(/&/g,"&amp;");
            // s = s.replace(/<form/g,"<p style='display: none'>#表单form标签start#</p>");
            s = s.replace(/<form/g,"#表单form标签start#");
            s = s.replace(/<\/form>/g,"#表单form标签end#");
            s = s.replace(/<html>/g,"#html标签start#");
            s = s.replace(/<\/html>/g,"#html标签end#");
            s = s.replace(/<head>/g,"#head标签start#");
            s = s.replace(/<\/head>/g,"#head标签end#");
            s = s.replace(/<body>/g,"#body标签start#");
            s = s.replace(/<\/body>/g,"#body标签end#");

            // if (s.indexOf('<!DOCTYPE') != -1){
            //     s = s.replace(/<!DOCTYPE html PUBLIC \\"-\/\/W3C\/\/DTD XHTML 1.0 Transitional\/\/EN\\" \\"http:\/\/www.w3.org\/TR\/xhtml1\/DTD\/xhtml1-transitional.dtd\\">/g,"#doctype标签#");
            // }
            return s;
        },
        ...
        htmlDecode : function (str){
            ...
            s = s.replace(/#表单form标签start#/g,"<form");
            s = s.replace(/#表单form标签end#/g,"</form>");
            s = s.replace(/#html标签start#/g, '<html>');
            s = s.replace(/#html标签end#/g,'</html>');
            s = s.replace(/#head标签start#/g,'<head>');
            s = s.replace(/#head标签end#/g,'</head>');
            s = s.replace(/#body标签start#/g,'<body>');
            s = s.replace(/#body标签end#/g,'</body>');


            if (s.indexOf('<html:select') != -1){
                s = s.replace(/styleclass/g,"styleClass");
                s = s.replace(/defaultoption/g,"defaultOption");
                s = s.replace(/otherattributes/g,"otherAttributes");
                s = s.replace(/selectedvalue/g,"selectedValue");
                s = s.replace(/labelfield/g,"labelField");
                s = s.replace(/valuefield/g,"valueField");

                s = s.replace(/>\s*<\/html:options>/g,"/>");
            }
            return s;
        },
        ...
        syncTextarea: function () {
            ...
            var htmlDecode = this.htmlDecode(t.$ed.html());
            t.$ta.val(htmlDecode);
        },
        syncCode: function (force) {
           // debugger
            ...
            if (!force && t.$ed.is(':visible')) {
                ...
                var encodeHtml = this.htmlEncode(t.$ta.val());
                t.$ed[0].innerHTML = encodeHtml;  //encodeURIComponent
                // t.$ed.html(t.$ta.val());
